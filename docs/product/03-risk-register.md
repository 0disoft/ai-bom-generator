...
| Large directory trees make artifact selection slow | Discovery can spend excessive time walking irrelevant directories before hashing | Bound incremental enumeration to 100,000 entries, prune universally excluded subtrees, and discard partial artifact selection on overflow |
