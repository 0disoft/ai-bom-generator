...
REQUIRED_SDIST_FILES = {
    ...
    "tests/fixtures/pipenv-lock-corpus/README.md",
    "tests/fixtures/pipenv-lock-corpus/pipenv-2023.12.1.lock",
    "tests/fixtures/pipenv-lock-corpus/pipenv-2026.6.2.lock",
