...
- Adds a version-pinned compatibility corpus generated by Pipenv 2023.12.1 and
  2026.6.2 and requires both producer outputs in source distributions.
- Adds deterministic property-style coverage for malformed JSON shapes and
  generated package evidence combinations without adding a fuzz dependency.
